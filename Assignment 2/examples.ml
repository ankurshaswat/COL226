...
let exp = Projection(2,Tuple([Const(12);Const(121);Const(33)]));;
let opcodes = compile (exp);;
execute [] [] opcodes;;

let exp = Subtraction(Projection(2,Tuple([Const(2);Const(5);Const(8)])),Const(1));;
let opcodes = compile (exp);;
execute [] [] opcodes;;

let exp = Modulus(Projection(2,Tuple([Const(2);Const(5);Const(8)])),Const(2));;
let opcodes = compile (exp);;
execute [] [] opcodes;;
...
let exp = Or(
	...
	And(Equal(Subtraction(Const(2),Const(1)),Const(1)),
		Modulus(Projection(2,Tuple([Const(2);Const(5);Const(8)])),Const(2))
	)
);;
let opcodes = compile (exp);;
execute [] [] opcodes;;
