...
let prog = [fact_edge_ab; fact_edge_be; fact_edge_ac; fact_edge_ce;fact_edge_ic; fact_path_xx; rule_path_xy; rule_path_xy'];;
(* let prog = [fact_edge_ab; fact_edge_be; fact_path_xx; rule_path_xy; rule_path_xy'];; *)
(* let prog = [fact_edge_ab; fact_edge_be; fact_edge_ce;fact_edge_ac;  fact_path_xx; rule_path_xy; rule_path_xy'];; *)
