...
type 'a myString = EmptyString | Alphabet of 'a | Combine of {mutable a:'a list;mutable b:'a list;mutable c:'a;mutable d:'a};;
...
let concat a b = match (a,b) with
  |  (a,EmptyString) -> a
  | (EmptyString,b) -> b
  |  (Alphabet(e1),Alphabet(e2)) -> Combine {a=[e1];b=[e2];c=e1;d=e2}
  | (Alphabet(e1),Combine{a=a1;b=b1;c=c1;d=d1}) ->  Combine{a=a1@[e1];b=b1;c=e1;d=d1}
  | (Combine{a=a1;b=b1;c=c1;d=d1},Alphabet(e1)) ->  Combine{a=a1;b=b1@[e1];c=c1;d=e1}
  | (Combine{a=a1;b=b1;c=c1;d=d1},Combine{a=a2;b=b2;c=c2;d=d2}) ->  Combine{ a=a1;b=b1@ (rev a2) @ b2 ;c=c1;d=d2} ;;

let reverse myString = match myString with
  |  EmptyString -> EmptyString
  | Alphabet (a)-> Alphabet (a)
  | Combine {a;b;c;d} -> myString.a <-b ; myString.b <-a ; myString.c <-d ; myString.d <-c;;
...
let forward myString = match myString with
  ...
  | Combine(a,x::xs,c,d) -> myString<-Combine([x]@a,xs,c,d);;
